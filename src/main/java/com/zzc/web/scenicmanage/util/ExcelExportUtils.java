...
public class ExcelExportUtils {
	...
	public  HSSFWorkbook inExcelMoreSheet(List list,String[] fields,String[] names,HSSFWorkbook wb,String sheetName) throws IOException, IllegalArgumentException, IllegalAccessException {
...
*/		HSSFRow row = null;
	...
	public  HSSFWorkbook inExcel(List list,String[] fields,String[] names) throws IOException, IllegalArgumentException, IllegalAccessException {
...
*/		HSSFRow row = null;
	...
	public  Map<String, String> getValue(Object t, String[] files) throws IllegalArgumentException, IllegalAccessException {
		...
		for (int i = 0; i < fields.length; i++) {
			...
			for (int j = 0; j < attr.length; j++) {
				if (attr[j].equals(field.getName())) {
					String value = (field.get(t)==null || field.get(t).toString().equals("null"))?"":field.get(t).toString();
					map.put(attr[j], value);
					//System.out.println(value);
					//System.out.println(field.getName() + ":" + field.get(t));// 读取属性值
				}
			}
		}
		return map;
