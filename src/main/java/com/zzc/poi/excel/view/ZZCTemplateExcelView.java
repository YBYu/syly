 ...
 */
package com.zzc.poi.excel.view;
...
public class ZZCTemplateExcelView extends MiniAbstractExcelView {

    public ZZCTemplateExcelView() {
        super();
    }
