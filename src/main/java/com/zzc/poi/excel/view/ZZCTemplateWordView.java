...
import com.zzc.poi.excel.entity.vo.TemplateWordConstants;
import com.zzc.poi.word.WordExportUtil;
...
public class ZZCTemplateWordView extends AbstractView {

    private static final String CONTENT_TYPE = "application/msword";

    public ZZCTemplateWordView() {
