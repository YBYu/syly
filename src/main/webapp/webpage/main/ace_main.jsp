...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title><t:mutiLang langKey="zzc.platform"/></title>
			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					...
					<a href="#" class="navbar-brand">
						<img style="height: 39px; margin-left: 10px;  margin-bottom: -11px;    margin-top: -7px; " src="./css/login/images/insanya_logo.png" alt="三亚旅游统计"> 
						<!-- <small>
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								...
								<span class="user-info" style="width:120px;">
									<small title="${userName }">欢迎，${userName }</small>
									<span style="color: #F5F5F5">
                    <span style="color: #F5F5F5"><t:mutiLang langKey="common.role"/>：</span>
                    <span style="color: #666633" title="${roleName }">${roleName }</span>
								</span>
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<script type="text/javascript">
					...
					window.onload = function(){
						$($("#menuList")[0].children[0].children[0]).click();
						if(navigator.userAgent.indexOf("MSIE 9.0")>0)  
					    {  
							$($("#menuList")[0].children[0]).find("li")[1].children[0].click();
					    }else{
							$($("#menuList")[0].children[0]).find("li")[0].children[1].click();
					    }  
					}
				</script>
			</div>
				...
				<div class="breadcrumbs" id="breadcrumbs" style="display:none">
					...
					<ul class="breadcrumb">
						<li>
							...
							<a href="loginController.do?home">主页</a>
						</li>
					</ul><!-- /.breadcrumb -->
					...
					<div  id="tabs" >
											<ul style="height:0px">
												<li style="list-style: none">
													<a href="#tabs-1" id="mainTitle"></a>
												</li>
											</ul>
							<div id="tabs-1" style="padding:0px">
						 		<iframe style="width:100%;height:530px;margin:0px;padding:0px" scrolling="auto" frameborder="0" id="center"  src="loginController.do?home" ></iframe>
							</div>
					</div>
				...
				<div class="footer-inner">
					...
					<div class="footer-content">
						<span class="bigger-120">
							Copyright© 2016 三亚旅游统计管理系统 All Right Reserved
						</span>
...
<![endif]-->
		...
		function loadModule(title,url,target){
	  	...
	  	function logout(){
	  		bootbox.confirm("确定退出本系统吗?", function(result) {
	  			if(result)
