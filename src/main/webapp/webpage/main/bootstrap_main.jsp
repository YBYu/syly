...
<div class="container-fluid"><a class="brand" href="#" target="_blank"><t:mutiLang langKey="common.platform"/> &nbsp;&nbsp;<span class="slogan"></span></a>
...
<ul class="footer-links">
	<li style="display: inline;">&copy; <t:mutiLang langKey="common.copyright"/><a href="#" title="ZZC Platform 1.0">ZZC Platform 1.0</a></li>
	<li style="display: inline;">&nbsp;<t:mutiLang langKey="common.copyright"/><t:mutiLang langKey="common.browser"/>:<a title="ZZC Platform 1.0" href="ZZC Platform 1.0">ZZC Platform 1.0</a></li>
</ul>
</div>
</footer>
