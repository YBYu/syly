...
<tr>
    ...
    <!--<img src="plug-in/login/images/logo.jpg"> 
        ...
        <div style="position: absolute; top: 75px; left: 33px;">ZZC Platform<span style="letter-spacing: -1px;">-1.0</span></div>
    </td>
...
<div region="south" border="false" style="height: 25px; overflow: hidden;">
    <div align="center" style="color: #1fa3e5; padding-top: 2px">&copy;
        ...
        <span class="tip">
            <a href="#" title="ZZC Platform -1.0">ZZC Platform -1.0</a>
