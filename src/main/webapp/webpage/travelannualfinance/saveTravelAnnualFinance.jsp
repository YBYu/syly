	...
	<t:formvalid formid="formobj" refresh="false" dialog="true"
		...
		<table id="tableReport" style="width: 680px; font-size: 12px;"
			...
			<thead>
				<tr>
					...
					<td width="100">
						<input type="text" name="name" datatype="*" class="inputSize"
							value="${traveldataInfo.name}" />
					</td>
					<td width="120">许可证编号</td>
					<td width="100">
						<input type="text" name="licensenum" datatype="*"
							class="inputSize" value="${traveldataInfo.licensenum}" />
					</td>
				<tr>
				<tr>
					<td width="120">填表人</td>
				...
				<td width="100"><input type="text" name="reportTime"
