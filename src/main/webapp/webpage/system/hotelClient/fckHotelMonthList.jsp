...
<t:datagrid  name="ckmonthList" title="" queryMode="group" actionUrl="hotelMonthlyController.do?fckDatagrid"  idField="id" fit="true">
			<t:dgCol title="酒店月报id" field="id" hidden="true"></t:dgCol>
			<t:dgCol title="月报id" field="hotelmanage.id" hidden="true"></t:dgCol>
			<t:dgCol title="酒店名称" field="hotelmanage.unitname" query="true" width="20"></t:dgCol>
			...
			<t:dgCol title="市级审核状态" field="status" width="10" query="false"
				replace="<font color=\"red\">未填报</font>_1,<font color=\"#d2980c\">未审核</font>_2,已审核(审核不通过)_3,已审核(审核通过)_4" ></t:dgCol>
			<t:dgCol title="省级审核状态" field="provinceState" width="10" query="false" replace="<font color=\"red\">未填报</font>_1,<font color=\"#d2980c\">未审核</font>_2,已审核(审核不通过)_3,已审核(审核通过)_4" ></t:dgCol>
