...
<body style="" scroll="yes">
	...
	<t:formvalid formid="saveAnnual" refresh="false" dialog="true"
		callback="reloadTable" action="hotelAnnualController.do?saveDai"
		usePlugin="password" layout="table" beforeSubmit="calc()">
		<div>
			<input type="hidden" value="${hotelmanageId }" name="hid">
			<input id="id" name="id" type="hidden" value="${annualData.id }">
		</div>
			...
			<tbody>
				<tr>
					...
					<td class="value" width="16%" colspan="4">
						<input type="text" value="${annualData.year}" name="year"
							class="creditCode" />
					</td>
				</tr>
				<tr>
					...
					<td class="value" width="16%" colspan="2">
						<input type="text" value="${annualData.hotelmanage.unitname}"
							name="name" class="creditCode" />
					</td>
					<td align="right" width="16%">
					...
					<td class="value" width="30%">
						<input type="text"
							value="${annualData.hotelmanage.organizationNum}" name="code" />
					</td>
				</tr>
