...
<t:formvalid formid="boatMonthSave" refresh="true" dialog="true" action="boatMonthlyController.do?saveDaibm" callback="reloadTable" layout="table">
	<%-- <input id="id" type="hidden" value="${boatMonthly.id }" name="otid"> --%>
...
<table style=" font-size:12px;" cellpadding="0" cellspacing="1" class="formtable">
		<tbody>
            ...
            <tr>
				...
				<td class="value" width="16%" colspan="2"><input value="${boatMonthly.otherTravelInfo.phone}" type="text"  readonly="readonly"  name="phone "></td>
                <td align="right" width="16%">邮政编码<span class="filedzt"></span></td>
                <td class="value" width="30%"><input value="${boatMonthly.otherTravelInfo.postalcode}" type="text"  readonly="readonly" name="postalcode "></td>
			</tr>
            <!--英文名称-->
            <tr>
                ...
                <td class="value" width="30%"><input value="${boatMonthly.income}" type="text" datatype="decimals4"   errormsg="请输入1-9位数字(最多四位小数)" " name="income"></td>
			</tr>
           <tr>
