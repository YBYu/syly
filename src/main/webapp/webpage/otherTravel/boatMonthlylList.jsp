...
<t:datagrid  name="userList2" title="" queryMode="group" actionUrl="boatMonthlyController.do?bdatagrid" 
idField="id" fit="true" sortName="dates" sortOrder="desc" >
	...
	<t:dgCol  title="企业名称"   field="otherTravelInfo.name"  query="true" ></t:dgCol>	     
	...
	<%-- <t:dgToolBar title="游艇月报导出" funname="exportExcel"></t:dgToolBar> --%>
	
<%-- <t:dgToolBar title="查看周报详情" langArg="common.user" icon="icon-edit" url="userController.do?addorupdate" funname="update"></t:dgToolBar> --%>
<%-- <t:dgToolBar title="游艇企业信息导出" langArg="common.user" icon="icon-put"  onclick="doMigrateOut();"></t:dgToolBar> --%>
...
function userListsearch(){
	...
	function exportExcel(){
		...
		window.open("boatMonthlyController.do?exportBoat&name="+name+"&status="+status);
	}
