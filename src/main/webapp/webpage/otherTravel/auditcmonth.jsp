...
<table style=" font-size:12px;" cellpadding="0" cellspacing="1" class="formtable">
		<tbody>
			...
			<tr>
                ...
                <input  value="${motorcarMonthly.smonth}" type="text"  datatype="*"     disabled="disabled" ></td>
            ...
            <tr>
				...
				<td class="value" width="16%" colspan="2"><input disabled="disabled" value="${motorcarMonthly.otherTravelInfo.phone}" type="text" ></td>
                <td align="right" width="16%">邮政编码<span class="filedzt"></span></td>
                <td class="value" width="30%"><input disabled="disabled" type="text" value="${motorcarMonthly.otherTravelInfo.postalcode}"></td>
			</tr>
            <!--英文名称-->
            <tr>
