...
<t:formvalid formid="saveflightMonth" refresh="false"  action="flightMonthlyController.do?saveDaifm" callback="reloadTable" dialog="true" layout="table">
...
<tbody>
		 <tr>
            ...
            <tr>
                ...
                <td class="value" width="30%"><input value="${flightMonthly.businessincome}" type="text" datatype="decimals4"   errormsg="请输入1-9位数字(最多四位小数)"  name="businessincome"></td>
			</tr>    
			<tr>
