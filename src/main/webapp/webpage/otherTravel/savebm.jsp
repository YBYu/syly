...
<t:formvalid formid="saveot" refresh="false" action="boatMonthlyController.do?savebm" callback="back" dialog="true"  layout="table">
	<%-- <input  value="${otherTravelInfo.id }" type="hidden" name="otid"> --%>
...
<table style="font-size:12px;" cellpadding="0" cellspacing="1" class="formtable">
		<tbody>
            ...
            <tr>
                ...
                <td class="value" width="30%"><input  value="${otherTravelInfo.postalcode }" type="text" datatype="*" ></td>
			</tr>
			
            <!--英文名称-->
            <tr>
				<td align="right" width="16%"><span class="filedzt">接待人次（单位：人次）</span></td>
				<td class="value" width="16%" colspan="2"><input   type="text" datatype="/^\d{1,9}(.\d{1,2})?$/"   errormsg="请输入1-9位数字(最多两位小数)"  name="recepNum"></td>
                <td align="right" width="16%"><span class="filedzt">营业收入（万元）</span></td>
                <td class="value" width="30%"><input   type="text" datatype="decimals4"   errormsg="请输入1-9位数字(最多四位小数)"  name="income"></td>
			</tr>
            <tr>
