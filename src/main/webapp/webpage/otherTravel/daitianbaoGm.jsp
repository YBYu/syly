...
<t:formvalid formid="saveot" refresh="true" dialog="true" callback="reloadTable" action="otherTravelMonthlyController.do?saveDaigm" layout="table">
...
<table style="font-size:12px;" cellpadding="0" cellspacing="1" class="formtable">
	 ...
	 <input   type="hidden" value="${otid }" name="otid"> 
            ...
            <tr>
                ...
                <td class="value" width="30%"><input value="${golfMonthly.businessincome}" type="text" datatype="decimals4" name="businessincome"></td>
			</tr>
            <tr>
