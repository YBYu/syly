...
<body style="" scroll="">  
<t:formvalid formid="formobj" refresh="true" dialog="true" action="scenicAnnualController.do?updateUser" usePlugin="password" layout="table">
	<input name="scenicdataid" type="hidden" value="${scenicdataid}">
		<input name="yearid" type="hidden" value="${yearid}">
   <input name="sid" type="hidden" value="${yeardata.sid }">
   <input name="status" type="hidden" value="${yeardata.status }">
   <input name="score" type="hidden" value="${yeardata.score }">
 ...
 <table style="width:650px; font-size:12px;" cellpadding="0" cellspacing="1" class="formtable">
		<tbody>
            ...
            <tr>
				...
				<td class="value" width="16%" colspan="2"><input type="text" value="${yeardata.inbuild}" name="inbuild" datatype="xs"  /></td>
            ...
            <tr>
				...
				<td class="value" width="16%" colspan="2"><input type="text" value="${yeardata.outbuild}" name="outbuild" datatype="xs" /><span class="red"></span></td>
            ...
            <tr>
				...
				<td class="value" width="16%" colspan="2"><input type="text" value="${yeardata.totalincome}" name="totalincome" datatype="xs"  /></td>
            ...
            <tr>
				...
				<td class="value" width="16%" colspan="2"><input type="text" value="${yeardata.ticketincome}" name="ticketincome" datatype="xs" /></td>
                <td align="right" width="16%"><span class="filedzt"> 商品收入（万元）</span></td>
                <td class="value" width="30%"><input type="text" value="${yeardata.shopincome}" name="shopincome" datatype="xs" /></td>
			</tr>
            <!--网址、邮政编码-->
            <tr>
				<td align="right" width="16%"><span class="filedzt">餐饮收入（万元）</span></td>
				<td class="value" width="16%" colspan="2"><input type="text" value="${yeardata.foodincome}" name="foodincome" datatype="xs" /></td>
                <td align="right" width="16%"><span class="filedzt">交通收入（万元）</span></td>
                <td class="value" width="30%"><input type="text" value="${yeardata.trafficincome}" name="trafficincome" datatype="xs" /></td>
			</tr>
            <!--单位负责人-->
			 <tr>
				<td align="right" width="16%"><span class="filedzt">演艺收入（万元）</span></td>
				<td class="value" width="16%" colspan="2"><input type="text" value="${yeardata.showincome}" name="showincome" datatype="xs"  /></td>
                <td align="right" width="16%"><span class="filedzt">住宿收入（万元）</span></td>
                <td class="value" width="30%"><input type="text" value="${yeardata.putUpincome}" name="putUpincome" datatype="xs" /></td>
			</tr>			
			
            <tr>
				<td align="right" width="16%"><span class="filedzt">其他收入（万元）</span></td>
				<td class="value" width="16%" colspan="2"><input type="text" value="${yeardata.otherincome}" name="otherincome" datatype="xs" /></td>
                <td align="right" width="16%"><span class="filedzt"></span></td>
            ...
            <tr>
				...
				<td class="value" width="16%" colspan="2"><input type="text" value="${yeardata.jobnum}" name="jobnum" datatype="n1-7" errormsg="只能为1-7位整数"/></td>
                <td align="right" width="16%"><span class="filedzt"></span></td>
				<td class="value" width="30%"></td>
			</tr>
			 ...
			 <tr>
				...
				<td class="value" width="16%" colspan="2"><input type="text" value="${yeardata.fixedworker}" name="fixedworker" datatype="n1-7" errormsg="只能为1-7位整数"/></td>
                <td align="right" width="16%"><span class="filedzt">临时（季节性）用工（人次）</span></td>
				<td class="value" width="30%"><input type="text" value="${yeardata.tempworker}" name="tempworker" datatype="n1-7" errormsg="只能为1-7位整数"/></td>
			</tr>
			 <tr>
