...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 1px;">
		...
		<t:datagrid name="leaveGrid" title="" queryMode="group"
			actionUrl="statisticTravelquarterController.do?outGridbytravel"
			idField="id" fit="true">
			...
			<t:dgCol title="亚洲" field="asianTotalOne" sortable="ture" width="10"></t:dgCol>
			<t:dgCol title="非洲" field="africaOne" sortable="ture" width="10"></t:dgCol>
			<t:dgCol title="欧洲" field="europeOne" sortable="ture" width="10"></t:dgCol>
			<t:dgCol title="美洲" field="americaTotalOne" sortable="ture"
				width="10"></t:dgCol>
			<t:dgCol title="大洋洲" field="oceaniaTotalOne" sortable="ture"
				width="10"></t:dgCol>
			<t:dgToolBar title="出境旅游大洲人次统计表（按旅行社）导出" langArg="common.user"
				icon="icon-put" onclick="doMigrateOut();"></t:dgToolBar>
