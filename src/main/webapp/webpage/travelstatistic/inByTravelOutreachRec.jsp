...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 1px;">
		...
		<t:datagrid name="leaveGrid" title="" queryMode="group"
			actionUrl="instatisticTravelquarterController.do?inlistByTravel"
			idField="id" fit="true">
			...
			<t:dgCol title="外联人次" field="inGuestOne" sortable="ture" width="10"></t:dgCol>
			<t:dgCol title="接待人次" field="inGuestTwo" sortable="ture" width="10"></t:dgCol>
