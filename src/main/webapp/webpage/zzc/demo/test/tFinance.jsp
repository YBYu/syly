			...
			<table>
				<c:forEach items="${tFinancePage.financeFiles}" var="financeFile">
					<tr style="height: 34px;">
						...
						<td><a href="commonController.do?viewFile&fileid=${financeFile.id}&subclassname=com.zzc.web.demo.entity.test.TFinanceFilesEntity" title="下载">下载</a></td>
						<td><a href="javascript:void(0);"
							onclick="openwindow('预览','commonController.do?openViewFile&fileid=${financeFile.id}&subclassname=com.zzc.web.demo.entity.test.TFinanceFilesEntity','fList','800','700')">预览</a></td>
