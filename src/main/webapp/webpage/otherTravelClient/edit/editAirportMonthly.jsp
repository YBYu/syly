...
<t:formvalid formid="saveAirportMonth"  action="airportMonthlyController.do?saveam"  callback="reloadTable" dialog="true"  layout="table">
	<input  value="${airportMonthly.otid }" type="hidden" name="otid">
	<input  value="${airportMonthly.id }" type="hidden" name="id">
	<input  value="${airportMonthly.dates }" type="hidden" name="dates">
...
<table style=" font-size:12px;" cellpadding="0" cellspacing="1" class="formtable">
		<tbody>
			...
			<tr>
                ...
                <td class="value" width="16%" colspan="4">
                <input   value="${airportMonthly.smonth}"   type="text"    name="smonth" readonly="readonly"   ></td>
         ...
         <td class="value" width="16%" colspan="4"><input  type="text"  value="${airportMonthly.plansortieyear }" datatype="n1-9" errormsg="只能为1-9位整数" name="plansortieyear"  ></td>
			 ...
			 <tr>
				...
				<td class="value" width="16%" colspan="2"><input  value="${airportMonthly.planouttraveller }" type="text" datatype="/^\d{1,9}(.\d{1,2})?$/"   errormsg="请输入1-9位数字(最多两位小数)"  name="planouttraveller"></td>
                <td align="right" width="16%"><span class="filedzt">本月实际出发运量-旅客(万人)</span></td>
                <td class="value" width="30%"><input   type="text" value="${airportMonthly.actualouttraveller }" datatype="/^\d{1,9}(.\d{1,2})?$/"   errormsg="请输入1-9位数字(最多两位小数)"  name="actualouttraveller"></td>
			</tr>
		<tr>
      	 <td align="right" width="16%">全年计划完成的到达运量-旅客(万人)</td>
         <td class="value" width="16%" colspan="4"><input  type="text"  value="${airportMonthly.planouttravelleryear }" name="planouttravelleryear"  datatype="/^\d{1,9}(.\d{1,2})?$/"   errormsg="请输入1-9位数字(最多两位小数)" ></td>
         ...
         <td class="value" width="16%" colspan="4"><input  type="text"  value="${airportMonthly.planoutwillyear }" name="planoutwillyear"  datatype="/^\d{1,9}(.\d{1,2})?$/"   errormsg="请输入1-9位数字(最多两位小数)" ></td>
			 ...
			 <tr>
				...
				<td class="value" width="16%" colspan="2"><input   type="text" value="${airportMonthly.planIntegerraveller }" datatype="/^\d{1,9}(.\d{1,2})?$/"   errormsg="请输入1-9位数字(最多两位小数)"  name="planIntegerraveller"></td>
                <td align="right" width="16%"><span class="filedzt">本月实际完成的到达运量-旅客(万人)</span></td>
                <td class="value" width="30%"><input   type="text" value="${airportMonthly.actualIntegerraveller }" datatype="/^\d{1,9}(.\d{1,2})?$/"   errormsg="请输入1-9位数字(最多两位小数)"  name="actualIntegerraveller"></td>
			</tr>
		<tr>
      	 <td align="right" width="16%">全年计划完成的到达运量-旅客(万人)</td>
         <td class="value" width="16%" colspan="4"><input  type="text"  value="${airportMonthly.planIntegerravelleryear }"  name="planIntegerravelleryear"  datatype="/^\d{1,9}(.\d{1,2})?$/"   errormsg="请输入1-9位数字(最多两位小数)"  ></td>
		...
		<tr>
         ...
         <td class="value" width="16%" colspan="4"><input  type="text"  value="${airportMonthly.planinwillyear }" name="planinwillyear"  datatype="/^\d{1,9}(.\d{1,2})?$/"   errormsg="请输入1-9位数字(最多两位小数)"  ></td>
			 ...
			 <tr>
				...
				<td class="value" width="16%" colspan="2"><input value="${airportMonthly.planthroughputtraveller }"  type="text" datatype="/^\d{1,9}(.\d{1,2})?$/"   errormsg="请输入1-9位数字(最多两位小数)"  name="planthroughputtraveller"></td>
                <td align="right" width="16%"><span class="filedzt">本月实际完成的吞吐量-旅客(万人)</span></td>
                <td class="value" width="30%"><input   type="text" value="${airportMonthly.actualthroughputtraveller }" datatype="/^\d{1,9}(.\d{1,2})?$/"   errormsg="请输入1-9位数字(最多两位小数)"  name="actualthroughputtraveller"></td>
			</tr>
	<tr>
      	 <td align="right" width="16%">全年计划完成的吞吐量-旅客(万人)</td>
         <td class="value" width="16%" colspan="4"><input  type="text"  value="${airportMonthly.planthroughputtravelleryear }" name="planthroughputtravelleryear"  datatype="/^\d{1,9}(.\d{1,2})?$/"   errormsg="请输入1-9位数字(最多两位小数)"  ></td>     
           </tr>
