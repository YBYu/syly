...
<body style="margin-left: 38px">
	<t:formvalid formid="formobj" refresh="false" dialog="true"
		action="travelQuarterController.do?saveOne" usePlugin="password"
		...
		<input id="dataId" name="id" type="hidden"
			value="${quarteroneData.id}" />
		<input name="tid" type="hidden" value="${quarteroneData.tid}" />
		...
		<table id="tableReport" style="width: 750px; font-size: 12px;"
			...
			<tbody>
				...
				<tr>
					...
					<td width="90">
						<input type="text" readonly="readonly" style="visibility: hidden"
							id="asiaTotalThree" value="${quarteroneData.asiaTotalThree}"
							name="asiaTotalThree" class="inputSize" style="width: 90px" />
					</td>
					<td width="90">
						<input type="text" readonly="readonly" style="visibility: hidden"
							id="asiaTotalFour" value="${quarteroneData.asiaTotalFour}"
							name="asiaTotalFour" class="inputSize" style="width: 90px" />
					</td>
				...
				<tr>
					...
					<td width="90">
						<input type="text" style="visibility: hidden" id="japanThree"
							value="${quarteroneData.japanThree}" name="japanThree"
							class="inputSize" style="width: 90px" />
					</td>
					<td width="90">
						<input type="text" style="visibility: hidden" id="japanFour"
							value="${quarteroneData.japanFour}" name="japanFour"
							class="inputSize" style="width: 90px" />
					</td>
				...
				<tr>
					...
					<td width="90">
						<input type="text" id="koreaThree" style="visibility: hidden"
							value="${quarteroneData.koreaThree}" name="koreaThree"
							class="inputSize" style="width: 90px" />
					</td>
					<td width="90">
						<input type="text" id="koreaFour" style="visibility: hidden"
							value="${quarteroneData.koreaFour}" name="koreaFour"
							class="inputSize" style="width: 90px" />
					</td>
				...
				<tr>
					...
					<td width="90">
						<input type="text" id="totalEropeanThree"
					...
					<td width="90">
						<input type="text" id="totalEropeanFour"
