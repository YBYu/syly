...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 1px;">
		...
		<t:datagrid name="leaveGrid" title="" queryMode="group"
			actionUrl="inlandStatisticTravelquarterController.do?zuzhiJieDaiDay"
			idField="id" fit="true">
			...
			<t:dgCol title="组织人天" field="sumOutreach" sortable="ture"></t:dgCol>
			<t:dgCol title="接待人天" field="sumRecept" sortable="ture"></t:dgCol>
