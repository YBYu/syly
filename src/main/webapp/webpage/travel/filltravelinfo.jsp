...
<body style="" scroll="">
	<t:formvalid formid="formobj" refresh="false" dialog="true"
		callback="reloadTable" action="travelController.do?fillInstead"
				...
				<tr>
					...
					<td class="value" colspan="2">
						<input type="text" value="${traveldata.province}" name="province"
							class="creditCode" nullmsg="统一社会信用代码" ignore="ignore" />
					</td>
					<td align="right">
				...
				<tr>
					...
					<td class="value" colspan="2">
						<input type="text" value="${traveldata.phone }" name="phone"
							datatype="c" class="creditCode" nullmsg="请输入固定电话" />
					</td>
					<td align="right">
