...
<!-- 			<tr>
			...
			<td ><div style="height:auto;" class="datagrid-cell datagrid-cell-c1-name">3</div></td>
				<td><div style="height:auto;" class="datagrid-cell datagrid-cell-c1-name">星级饭店重要指标同比统计（指标排序表）</div></td>
				<td><div style="height:auto;" class="datagrid-cell datagrid-cell-c1-name"><a id="btn1" href="#"  onclick="daochu2()" >点击下载报表</a></div></td>
			</tr> 
	...
	function daochu0(){
		...
		window.open("exportQuarterController.do?exports1&year="+year+"&quarter="+quarter+"&star="+star);
	...
	function daochu1(){
		...
		var quarter=$('#quarter')[0].value;
		var star=$('#star')[0].value;
		window.open("exportQuarterController.do?exports2&year="+year+"&quarter="+quarter+"&star="+star);	
	}
	function daochu2(){
		//var area=$('#area')[0].value;
		...
		var quarter=$('#quarter')[0].value;
		var star=$('#star')[0].value;
		window.open("exportQuarterController.do?exports3&year="+year+"&quarter="+quarter+"&star="+star);	
	}
		// 表格刷新方法
