						...
						<table width="640">
							...
							<tr>
								<td>
									...
									<input type="text" name="taking" value="${monthdata.taking}"
										id="income" class="text" style="width: 158px">
								</td>
								<td>
									<span style="width: 180px;">营业税金及附加（万元）：</span>
									<input type="text" name="businesstax"
										value="${monthdata.businesstax}" id="BusinessTax" class="text"
										style="width: 113px">
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td>
									...
									<input type="text" name="totalprofit"
										value="${monthdata.totalprofit}" id="ProfitSum" class="text"
										style="width: 158px">
								</td>
								<td></td>
							</tr>
							<tr>
								<td>
									...
									<input type="text" name="endemployee"
										value="${monthdata.endemployee}" id="employees" class="text"
										style="width: 143px">
								</td>
								<td>
									<span style="width: 180px;">其中吸纳下岗职工（人）：</span>
									<input type="text" name="laidworker"
										value="${monthdata.laidworker}" id="LaidOff" class="text"
										style="width: 113px">
								</td>
							</tr>
							<tr>
								...
								<td>
									...
									<input type="text" name="countrylabor"
										value="${monthdata.countrylabor}" id="RuralLabor" class="text"
										style="width: 98px">
								</td>
							</tr>
							<tr>
								<td>
									...
									<input type="text" name="price" value="${monthdata.price}"
										id="OgValue" class="text" style="width: 128px">
								</td>
								<td></td>
							</tr>
							<tr>
								<td>
									...
									<input type="text" name="asset" value="${monthdata.asset}"
										id="NetValue" class="text" style="width: 128px">
								</td>
							</tr>
							<tr>
								<td>
									<span style="width: 49px;">团散比:</span>
									<input type="text" name="compare" value="${monthdata.compare}"
										id="GroupRate" class="text" style="width: 244px">
								</td>
							</tr>
							<tr>
								<td>
									...
									<input type="text" name="principal"
										value="${monthdata.principal}" id="PerCharge" class="text"
										style="width: 203px">
								</td>
								<td>
									<span style="width: 60px;">填表人：</span>
									<input type="text" name="preparer"
										value="${monthdata.preparer}" id="FillTable" class="text"
										style="width: 233px">
								</td>
							</tr>
							<tr>
								<td>
									...
									<input type="text" name="telephone"
										value="${monthdata.telephone}" id="FillTable" class="text"
										style="width: 248px">
								</td>
								<td>
									<span style="width: 75px;">报出日期：</span>
									<input type="text" name="reportdate"
										value="${monthdata.reportdate}" id="SubDate" class="FillTable"
										style="width: 218px">
								</td>
							</tr>
						</table>
